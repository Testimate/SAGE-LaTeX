%% https://www.sharelatex.com/templates/58d20eace243a8422cb2aff9/v/0/pdf?inline=true&name=SAGE%20LaTeX%20template
...
%% Testimate: original with sageh
% \documentclass[Afour,sageh,times]{sagej}
%% for Vancouver, change to sagev --> supersript number! %% \cite, \citet!
